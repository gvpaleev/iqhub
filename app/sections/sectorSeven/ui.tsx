...
export function SectionSeven() {
  const data = [{
    ...
    'cards': [
      ["1 занятий", "с опытным специалистом", "900 руб", "(стоимость одного занятия 1100руб)", "с молодым специалистом", "4800 руб", "(стоимость одного занятия 1100руб)"]
      , ["6 занятий", "с опытным специалистом", "850 руб", "(стоимость одного занятия 1100руб)", "с молодым специалистом", "4800 руб", "(стоимость одного занятия 1100руб)"]
      , ["12 занятий", "с опытным специалистом", "800 руб", "(стоимость одного занятия 1100руб)", "с молодым специалистом", "4800 руб", "(стоимость одного занятия 1100руб)"]
    ]
  },
  {
